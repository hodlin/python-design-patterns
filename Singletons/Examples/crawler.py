...
def traverse_site(max_links=10):
    ...
    while link_parser_singleton.queue_to_parse:
        ...
        if status.get('content_type') != 'text/html':
            continue
        ...
        link_url = (parsed.scheme or parsed_root.netloc) + parsed.path or ''
...
def download_images(thread_name):
    ...
    while singleton.to_visit:
        ...
        for image in images:
            ...
            # If rhe image url is absolute, it will remain as is
            src = urljoin(url, src)

            # Get a basename, for example 'image.png' to name file locally
...
if __name__ == '__main__':
    root = 'http://www.radio-focus.com/index.php'
