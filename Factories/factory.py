...
class HTTPConnector(Connector):
    """ A complete creator that creates a HTTP connector and sets in runtime all its attributes. """
    ...
    def port_factory_method(self):
        """ Here HTTPPort and HTTPSPort are concrete objects, created by factory method """
        if self.is_secure:
